...
namespace MyGui.net
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			TreeNode treeNode3 = new TreeNode("Node1", new TreeNode[] { treeNode1, treeNode2 });
			...
			TreeNode treeNode8 = new TreeNode("Node0", new TreeNode[] { treeNode3, treeNode4, treeNode5, treeNode6, treeNode7 });
			TreeNode treeNode9 = new TreeNode("Node9");
			TreeNode treeNode10 = new TreeNode("Node13");
			TreeNode treeNode11 = new TreeNode("Node17");
			TreeNode treeNode12 = new TreeNode("Node15", new TreeNode[] { treeNode11 });
			TreeNode treeNode13 = new TreeNode("Node16");
			TreeNode treeNode14 = new TreeNode("Node14", new TreeNode[] { treeNode12, treeNode13 });
			TreeNode treeNode15 = new TreeNode("Node10", new TreeNode[] { treeNode10, treeNode14 });
			TreeNode treeNode16 = new TreeNode("Node21");
			TreeNode treeNode17 = new TreeNode("Node22");
			TreeNode treeNode18 = new TreeNode("Node23");
			TreeNode treeNode19 = new TreeNode("Node20", new TreeNode[] { treeNode16, treeNode17, treeNode18 });
			TreeNode treeNode20 = new TreeNode("Node18", new TreeNode[] { treeNode19 });
			TreeNode treeNode21 = new TreeNode("Node27");
			TreeNode treeNode22 = new TreeNode("Node19", new TreeNode[] { treeNode21 });
			TreeNode treeNode23 = new TreeNode("Node11", new TreeNode[] { treeNode20, treeNode22 });
			TreeNode treeNode24 = new TreeNode("Node24");
			TreeNode treeNode25 = new TreeNode("Node25");
			TreeNode treeNode26 = new TreeNode("Node26");
			TreeNode treeNode27 = new TreeNode("Node12", new TreeNode[] { treeNode24, treeNode25, treeNode26 });
			TreeNode treeNode28 = new TreeNode("Node8", new TreeNode[] { treeNode9, treeNode15, treeNode23, treeNode27 });
			...
			treeView1.Cursor = Cursors.PanNW;
			...
			treeNode19.Text = "Node20";
			treeNode20.Name = "Node18";
			treeNode20.Text = "Node18";
			...
			treeView1.Nodes.AddRange(new TreeNode[] { treeNode8, treeNode28 });
